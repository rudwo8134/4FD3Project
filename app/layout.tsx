...
export const metadata: Metadata = {
  title: "4FD3 Project - AI-Powered Resume Automation Platform",
  description:
    "Automate your job applications with AI-powered resume matching and guided application processes. Upload your resume, find relevant jobs, and apply automatically with 4FD3 Project.",
  keywords: [
    "job search",
    "resume automation",
    "AI job matching",
  ...
  authors: [{ name: "4FD3 Project Team" }],
  creator: "4FD3 Project",
  publisher: "4FD3 Project",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  openGraph: {
    ...
    siteName: "4FD3 Project",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "4FD3 Project - AI-Powered Resume Automation Platform",
      },
    ],
    locale: "en_US",
    type: "website",
